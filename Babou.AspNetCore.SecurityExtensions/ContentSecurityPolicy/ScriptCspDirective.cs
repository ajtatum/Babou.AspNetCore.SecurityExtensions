...
namespace Babou.AspNetCore.SecurityExtensions.ContentSecurityPolicy
{
    public class ScriptCspDirective : CspDirectiveBase
    {
        ...
        public static ScriptCspDirective None { get; } = new ScriptCspDirective(NoneString);
        public static ScriptCspDirective Self { get; } = new ScriptCspDirective(SelfString);
        ...
        public ScriptCspDirective AddHashOf(string content, Encoding encoding, CspHashAlgorithm algorithm = CspHashAlgorithm.Sha256)
        {
            ...
            var rawContent = encoding.GetBytes(content);
            using var hashAlgorithm = algorithm.CreateHashAlgorithm();
